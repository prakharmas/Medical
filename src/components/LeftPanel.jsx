  ...
  return (
    <section className="left" aria-label="ClinIQ overview">
      ...
      <div className="intro">
        ...
        <h1>Review patient records<br />in minutes, not hours.</h1>
        <p>CliniQ structures messy patient documents, generates clinical summaries, and lets you dictate notes — all powered by AI built for oncologists.</p>
        <div className="chips" aria-label="ClinIQ features">
          <span><b>?</b> AI-generated SOAP notes</span>
          <span><b>?</b> Voice-to-clinical text</span>
      ...
      <div className="footer">
        ...
        <p><span>AIIMS</span><span>Tata Memorial</span><span>Apollo</span><span>Fortis</span><span>Manipal</span></p>
      </div>
    </section>
  );
}
